...
export const router = createRouter({
	...
	routes: [
		...
		{ path: '/entries/:entryId(\\d+)', name: 'entries', component: EntryDetailView , props: true},
		{ path: '/entries/:entryId(\\d+)/edit', name: 'entryEdit', component: EntryEditView, props: true },
		{ path: '/diaries', name: 'diaries', component: DiaryDetailView },
		{ path: '/diaries/new', name: 'diaryCreate', component: DiaryEditView },
		{ path: '/diaries/:entryId(\\d+)/edit', name: 'diaryEdit', component: DiaryEditView, props: true},
		{ path: '/diaries/:entryId(\\d+)/edit_share', name: 'diaryEditShare', component: DiaryEditView, props: true},
		...
		{ path: '/questions/:questionId(\\d+)', name: 'questions', component: QuestionDetailView, props: true },
		{ path: '/questions/:questionId(\\d+)/edit', name: 'questionEdit', component: QuestionEditView, props: true },
	],
})
